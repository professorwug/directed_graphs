...
__all__ = ['compute_grid', 'diffusion_matrix_with_grid_points', 'FeedForwardReLU', 'MultiscaleDiffusionFlowEmbedder',
           'ffrelu_encoder', 'ffrelu_decoder', 'default_weights']

# Cell
from .diffusion_flow_embedding import affinity_matrix_from_pointset_to_pointset, smoothness_of_vector_field
...
ffrelu_encoder = FeedForwardReLU(shape=(3,4,8,4,2))
ffrelu_decoder = FeedForwardReLU(shape=(2,4,8,4,3))
default_weights = {
			"diffusion":1,
			"smoothness":0,
			"reconstruction":0,
...
class MultiscaleDiffusionFlowEmbedder(torch.nn.Module):
	def __init__(self,
							...
							embedder = ffrelu_encoder,
							decoder = ffrelu_decoder,
							labels = None,
