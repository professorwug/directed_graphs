# AUTOGENERATED! DO NOT EDIT! File to edit: 22_Small_Directed_Graphs.ipynb (unless otherwise specified).
...
class SmallRandom(InMemoryDataset):
  def __init__(self, num_nodes=5, prob_edge=0.2, transform=None):
