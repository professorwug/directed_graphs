# AUTOGENERATED! DO NOT EDIT! File to edit: 21_Communities_Datasets.ipynb (unless otherwise specified).

__all__ = ['EmailEuNetwork', 'SourceSink']
...
class SourceSink(BaseTransform):
  ...
  def __call__(self, data):
    ...
    data.edge_index = torch.t(torch.tensor(edge_array))
    data.y = y
    return data